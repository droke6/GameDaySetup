    ...
    if request.method == 'POST':
        ...
        def process_data(data, location):
            ...
            courts = {
                ...
                'Murphy': ['PSA - Murphy 1', 'PSA - Murphy 2', 'PSA - Murphy 3', 'PSA - Murphy 4', 'PSA - Murphy 5', 'PSA - Murphy 6', 'PSA - Murphy 7', 'PSA - Murphy 8'],
                'Plano': ['PSA 1 - Blue 5 (VB)', 'PSA 1 - Blue 4', 'PSA 1 - Blue 3', 'PSA 1 - Blue 2', 'PSA 1 - Blue 1', 'PSA 1 - Green 2', 'PSA 1 - Green 3', 'PSA 1 - Green 4', 'PSA 1 - Green 5', 'PSA 1 - Red 5']
            }
