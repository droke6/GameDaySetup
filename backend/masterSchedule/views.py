    ...
    if request.method == 'POST':
        ...
        def process_data(data, location):
            ...
            courts = {
                ...
                'Plano': ['PSA 1 - Blue 5 (VB)', 'PSA 1 - Blue 4', 'PSA 1 - Blue 3', 'PSA 1 - Blue 2', 'PSA 1 - Blue 1','PSA 1 - Green 1', 'PSA 1 - Green 2', 'PSA 1 - Green 3', 'PSA 1 - Green 4', 'PSA 1 - Green 5', 'PSA 1 - Red 4', 'PSA 1 - Red 5']
            }
